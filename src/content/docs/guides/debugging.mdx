...
There's a built-in logger that can help diagnose some issues. It will split logs into two files:
...
:::tip
  [yq](https://github.com/mikefarah/yq) is a convenient way to edit configuration
  files from the command line.

  It's available at several package managers:
  Homebrew, Winget, Chocolatey, and Scoop.
:::
