...
memos:
  ...
  #
  # Listening to 127.0.0.1 won't trigger Windows Firewall, and
  # the server instance will only be accessible from the host
  # computer. This is the default.
  #
  # Listening to 0.0.0.0 will make the server available
  # at all your computer's network adapters addresses
  # (as long as it's allowed by your firewall).
  addr: 127.0.0.1
...
memospot:
  ...
  env:
    ...
    # Empty values will unset the variable.
    enabled: false
    vars:
