...
[Blue Oak Model License 1.0.0](https://choosealicense.com/licenses/blueoak-1.0.0/).

In short, when you submit code changes, your submissions are understood to be under the same
_Blue Oak Model License 1.0.0_ that covers the project. Feel free to contact the maintainer if that's a concern.
...
<details>
  ...
  :::note[sudo]
    To avoid invoking `docker` with `sudo --preserve-env`, consider adding yourself to the `docker` user group:
    ```bash
...
- src-ui (Svelte front-end code)
  ...
  - src/
    - lib/ (components and utilities)
      - i18n.ts (localization fallbacks)
      - …
    - routes/ (app UI windows)
      - loader/
      - settings/
    - …
  - …
